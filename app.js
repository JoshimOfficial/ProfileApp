...
let social_text = document.querySelector(".social_text");
...
let social_link_text_bio = document.querySelector(".social_link_text_bio");
let social_links_bio = document.querySelector(".social_links_bio");
let social_bio_text = document.querySelector(".social_bio_text");
...
about.addEventListener("click", (e)=> {
    ...
    social_link_text_bio.style.opacity="0";
})
...
//When user click on social button then all "social" will be show 
social.addEventListener("click", ()=> {
    social_text.style.opacity = "1";
    about_text.style.opacity = "0";
    education_text.style.opacity ="0";
    achievement_text.style.opacity = "0";
    experience_text.style.opacity ="0";
    ...
    achive_bio.style.opacity = "0"
    about_bio.style.opacity = "0";
    social_link_text_bio.style.opacity ="1"
    social_link_text_bio.style.opacity = "1";
    social_bio_text.style.opacity = "1"
    education_bio.style.opacity = "0";
    table_cv.style.opacity = "0"
})

social.addEventListener("click", ()=> {
    setTimeout(social_links_bio_set_time, 600) 
    function social_links_bio_set_time() {
        social_links_bio.style.opacity ="1";
    }
})
